...
const PatientPortal = () => {
    ...
    return (
        <div className="patient-portal-container">
            <header>
                <h2 className='pat'>Patient Portal</h2>
                {reminderMessage ? (
            ...
            {/* <button onClick={handleviewAppointmnet}>View Appointments</button> */}
            <button onClick={goToLabReportForm}>Lab Report</button>
            <button onClick={goTofeedbackForm}>FeedbackForm</button>
            <button onClick={goToOffer}>Offer Card</button>
            <button onClick={goToTherapy}>Therapy Form</button>
            </div>
            {showTreatmentList && (
